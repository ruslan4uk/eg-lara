...
<head>
    <style>
        ...
        .background {
            background-image: url('https://api.excursguide.ru/images/mails/moderate-tour.png');
                        ...
                        <table width="600" cellpadding="0" cellspacing="0" border="0" align="center" class="devicewidth">
                            ...
                            <tr>
                                <td width="100%" bgcolor="#ffffff" style="border-radius: 0 0 25px 25px; padding: 30px; background-color: #ffffff;">
                                    ...
                                    <a href="https://excursguide.ru/excursion/{{ $data->tour_id }}" target="_blank"
                                       style="line-height: 16px; display:inline-block; padding: 13px 22px; color: #ffffff; background-color: #405089; border-radius: 25px; font-size: 16px; text-decoration: none;">Страница экскурсии</a>
                                </td>
                            </tr>
                            <!-- Spacing -->
                            <tr>
