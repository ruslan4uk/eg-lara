                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td width="100%" bgcolor="#ffffff" style="border-radius: 0 0 25px 25px; padding: 30px; background-color: #ffffff;">
                                            ...
                                            <a href="https://excursguide.ru" target="_blank" style="line-height: 16px; display:inline-block; padding: 13px 22px; color: #ffffff; background-color: #405089; border-radius: 25px; font-size: 16px; text-decoration: none;">ОТ ВИНТА!</a>
                                        </td>
                                    </tr>
                                    <!-- Spacing -->
                                    <tr>
