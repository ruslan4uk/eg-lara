                        ...
                        <table width="600" cellpadding="0" cellspacing="0" border="0" align="center" class="devicewidth">
                            ...
                            <tr>
                                <td width="100%" bgcolor="#ffffff" style="border-radius: 0 0 25px 25px; padding: 30px; background-color: #ffffff;">
                                    ...
                                    <h4>Напоминаем о том, что твой профиль не заполнен на 100%, а это значит, что туристы до сих пор не видят твоих экскурсий.</h4>
                                        ...
                                        <tr>
                                            <td width="65%">
                                                <p style="color: #585f76; margin-bottom: 20px;">
                                                    А мы уверены, что у тебя есть что показать этому миру и предложить туристам!
                                                </p>

                                                <p style="color: #585f76; margin-bottom: 20px;">
                                                    Если ты еще не успел разместить экскурсии на нашем сайте, то рекомендуем это сделать вместе с заполнением профиля.
                                                    Мы с радостью их одобрим и разместим )
                                                </p>

                                                <p style="color: #585f76;">
                                                    Остался 1 шаг.<br/>
                                                    И этот шаг имеет все шансы быть одним из самых верных шагов в твоей жизни!
                                                </p>
                                            </td>

                                            <td width="35%">
                                                <img src="{{ asset('images/mails/persons/4.png')  }}" alt="" width="100%">
                                            </td>
                                        </tr>
                                        </tbody>
                                    </table>
                                        ...
                                        <tr>
                                            ...
                                            <td width="60%">
                                                <p style="color: #585f76; margin-bottom: 20px; margin-top: 20px;">
                                                    Держи небольшую инструкцию, какие поля обязательно необходимо заполнить для
                                                    того, чтобы твои экскурсии отображались у нас на сайте:
                                                </p>

                                                <a href="https://excursguide.ru/" target="_blank" style="line-height: 16px; display:inline-block; padding: 13px 22px; color: #ffffff; background-color: #405089; border-radius: 25px; font-size: 16px; text-decoration: none;">Инструкция</a>
                                            </td>
                                        </tr>
                                        </tbody>
                                    </table>
                                    ...
                                    <p style="color: #585f76; margin-bottom: 20px;">
                                        Есть вопросы? Мы с радостью ответим и поможем.<br/>
                                        Пиши на info@excursguide.ru
                                    </p>
